...
module.exports.index = (req, res) => {
  ...
  return fs.stat(cachedFilePath, function(err) {
    ...
    .then((code) => {
      ...
      // This is to allow us to use line numbers if specified
      let linenums = '';
      if(req.query['linenums']) {
        linenums = 'linenums';
      }

      // Add the openening and closing pre tags
      let wrappedCode =''
      let genCSS = 'position: relative; top: 5px; padding: 5px; border-top: 1px #333333 solid; font-family: sans-serif; font-size: 12px; font-weight: 900; margin-top: -20px; margin-bottom: 20px; background: #000000;';
